...
if __name__ == "__main__":
    ...
    t20_match_players_stream = """ 

        CREATE STREAM IF NOT EXISTS match_players WITH(VALUE_FORMAT='AVRO', KEY_FORMAT='AVRO') as 
    ...
    print(create_stream(client, t20_match_players_stream))
